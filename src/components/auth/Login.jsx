  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.idToken) {
        ...
        console.log("Login successful"+data.idToken);
      } else {
            ...
            <div className="col-md-6 col-xl-4">
                <div className="card mb-5">
                    <div className="card-body d-flex flex-column align-items-center">
                        ...
                        <form className="text-center form-floating" method="post">
                            <div className="mb-3"><input className="form-control" type="email" id="em" name="email" placeholder="Email" ref={emailRef} />
                            <label htmlFor="em" className="floatingInput">Email</label>
                            </div>
                            
                            <div className="mb-3"><input className="form-control" type="password" name="password" placeholder="Password" id="pw" ref={passwordRef} /></div>
